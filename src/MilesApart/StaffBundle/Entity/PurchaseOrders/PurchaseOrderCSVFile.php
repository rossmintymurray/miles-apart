...
class PurchaseOrderCSVFile
{
     ...
     * @return CSVFile
     */
    public function setPurchaseOrderCSVFilePath($csvFilePath)
    {
     ...
     * @return string 
     */
    public function getPurchaseOrderCSVFilePath()
    {
