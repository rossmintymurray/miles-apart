...
class ExistingCustomerCheckoutDeliveryType extends AbstractType
{
    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
       ...
       $builder->add('delivery_address_id', 'hidden', array(
            'data' => 0,
            'mapped' => false,
            'required' =>false,
        ));

       $builder->add('billing_address_id', 'hidden', array(
            'data' => 0,
            'mapped' => false,
            'required' =>false,
        ));
